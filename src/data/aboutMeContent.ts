    ...
    intro: [
      {
        parts: [
          {
            text: "Hi, I'm Martin, I'm from the countryside and I've been working in ",
            bold: false,
          },
          { text: 'IT', bold: true },
          { text: ' for ', bold: false },
          { text: '4 years', bold: true },
          { text: ", and I'm also ", bold: false },
          { text: 'self-employed', bold: true },
          { text: '.', bold: false },
        ],
      },
      {
        parts: [
          ...
          { text: 'student', bold: true },
          {
            text: ', I enjoy sports and talking with people I can learn from.',
            bold: false,
          },
        ],
      },
      {
        parts: [
          { text: 'My strong interest in learning and ', bold: false },
          { text: 'personal growth', bold: true },
          { text: ' motivates me to seize every ', bold: false },
          { text: 'opportunity', bold: true },
          { text: ' for career growth.', bold: false },
        ],
      },
      {
        parts: [
          { text: 'I look forward to ', bold: false },
          { text: 'facing', bold: true },
          { text: ' new challenges and ', bold: false },
          { text: 'contributing', bold: true },
          { text: ' to our shared success.', bold: false },
        ],
      },
      {
        parts: [
          { text: "English isn't a barrier for me - my grammar is at ", bold: false },
          { text: 'B1', bold: true },
          { text: ' level, and my spoken English is between ', bold: false },
          { text: 'A2 and B1.', bold: true },
        ],
      },
    ],
    sections: [
      ...
      },
      {
        title: 'Hobbies',
        groups: [
          { title: 'Sport', description: 'Any sport that keeps me active and fit.' },
          {
          ...
          {
            title: 'Communication',
            description: 'Talking with people who share my interests inspires and motivates me.',
          },
          {
            title: 'The world of IT',
            description: "I'm into programming, app design, and finding innovative solutions.",
          },
        ],
      },
      {
